    ...
    <RNScrollView contentContainerStyle={styles.scrollContainer}>
      <View style={styles.container}>
        ...
        <ChartPie
          ...
          accessor="value" // Specify the data key for values
          backgroundColor="transparent" // Set background color
          paddingLeft="15" // Add padding for better alignment
        />

        {/* Portfolio Summary */}
        <View style={styles.walletContainer}>
          <Text style={styles.walletText}>Portfolio Value: ₹{portfolioValue}</Text>
          <Text style={styles.walletText}>Cash: ₹{cash}</Text>
          <Text style={styles.walletText}>Total: ₹{portfolioValue + cash}</Text>
        </View>

        {/* Scrolling Stock Bar */}
        <RNScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.stockBar}>
